  ...
  return (
    <footer className={`${family} py-8`}>
      <div className='container mx-auto px-4'>
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
          ...
          <div>
            ...
            <div className='space-y-2'>
              {address && <p className=' text-xl'>{address}</p>}
              {phone && <p className=' text-xl'>Tel: {phone}</p>}
              {email && (
            ...
            <div className='flex space-x-4'>
              ...
              {socialLinks.youtube && (
                <a
                  ...
                  target='_blank'
                  rel='noopener noreferrer'
                  className=' hover:bg-gray-500 transition duration-200'
                  aria-label='youtube'
                >
                  <Youtube size={24} />
                </a>
        ...
        {/* Prawa autorskie */}
        <div className='border-t border-gray-500 mt-8 pt-6 text-center text-xl '>
          <p>
